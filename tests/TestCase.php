...
use Padosoft\Iam\Ai\IamAiServiceProvider;
use Padosoft\Iam\IamServiceProvider;

abstract class TestCase extends Orchestra
{
    /**
     * The AI module is tested together with the server package (its in-process PDP,
     * audit models and migrations), resolved from Packagist as a dev dependency.
     *
